...
to only allow single row selections or disable it you can set the selection argument
...
* ... free parameters list to pass table customization options. 
...
selectedrows <- downloadableTable("object_id1", 
                                  ...
                                  # could also be "multiple, single or none"
                                  selection = mydataRowIds,
                                  # custom column names
                                  colnames = c("Column1", "Column2", "Column3"),
                                  # where to place column filters controls
                                  filter = "bottom", 
                                  # table width
                                  width = "150px",
                                  # table height
                                  height = "50px",
                                  # add addition DT extension function
                                  extensions = 'Buttons',
                                  # if TRUE, user will need to save edited data in server function
                                  editable = TRUE,
                                  # needed for the extension function
                                  dom = 'Bfrtip',
                                  # the extension function buttons
                                  buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
                                  # custom style for "Column1"
                                  formatStyle = list(columns = c('Column1'),  color = 'red'),
                                  # advanced custom style for "Column2"
                                  formatStyle = list(columns = c('Column2'), 
                                                     color = DT::styleInterval(0, c('red', 'green'))),
                                  # format "Column3" as a currency column
                                  formatCurrency = list(columns = c('Column3'))))
