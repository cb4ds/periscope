...
* Sample apps contain a widget for updating app styles momentarily as follow:

<center><img src="figures/App_Styling.jpg" width="800px"></center>

* The generated yaml file for blank applications will contain no values for the properties. So application will use default style options.
